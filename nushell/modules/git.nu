...
# export alias gpA = ^git push --all && ^git push --tags
export alias gpt = ^git push --tags
# export alias gpc = ^git push --set-upstream origin "$(git-branch-current 2> /dev/null)"
# export alias gpp = ^git pull origin "$(git-branch-current 2> /dev/null)" && git push origin "$(git-branch-current 2> /dev/null)"
